...
const SatisEmirYukle = (dbName,coll,Side,callback) =>{
...
const AlisEmirYukle = (dbName,coll,Side,callback) =>{
    _db.db(dbName).collection(coll).aggregate([
        {$match: { side: Side}}
      , {$group:
          {_id: '$kur', miktar: {$sum: '$miktar'}, kur: {$first:'$kur'} }},
...
module.exports = {connectDB,getDB,disconnectDB,insertDB,selectDB,updateDB,selectOneDB,deleteDB,AlisEmirYukle,SatisEmirYukle,bakiyeArtir,bakiyeAzalt}